# extractNet_connected_vgg11_bn.py
# Contains Interconnected Autoencoder model (Encoder VGG11BN, Decoder VGG-mirror)
...
class extractNet_connected_vgg11_bn(nn.Module):
	def __init__(self):
		super(extractNet_connected_vgg11_bn, self).__init__()

		vgg11_bn = torchvision.models.vgg.vgg11_bn(pretrained=True)

		# Maxpool output layers
		self.encoder_out_layers = [3,7,14,21,28]
