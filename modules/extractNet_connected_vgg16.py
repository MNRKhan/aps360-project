# extractNet_connected_vgg16.py
# Contains Interconnected Autoencoder model (Encoder VGG16, Decoder VGG-mirror)
...
class extractNet_connected_vgg16(nn.Module):
	def __init__(self):
		super(extractNet_connected_vgg16, self).__init__()
